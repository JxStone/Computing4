...
void Body::step(double seconds, double force_x, double force_y)
{
    double accel_x = force_x / _mass;
    double accel_y = force_y / _mass;
    
    _xvel += accel_x * seconds;
    _yvel += accel_y * seconds;
